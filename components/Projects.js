    ...
    return (
        <div className="w-full flex-col med:flex-row items-center align-center">
            ...
            <div className="w-full p-4 ">
                {/*Portfolio*/}
                <div className="flex mt-2 hover:scale-105 transition border-b-2  lg:p-0 p-4 space-y-4 flex-col text-left">
                ...
                {/*Google*/}
                <div className="flex mt-8 lg:p-0 hover:scale-105 transition  p-4 border-b-2 space-y-4 flex-col text-left">
                    ...
                    {/*Hashtags*/}
                    <div className="flex overflow-x-scroll  sm:overflow-x-visible space-x-4 pb-4">
                        <h4 id="location" className="text-xs bg-white border-2 border-black  p-2 rounded-lg font-semibold text-black">React JS</h4>
                        <h4 id="location" className="text-xs bg-white border-2 border-black  p-2 rounded-lg font-semibold text-black">Next JS</h4>
                        <h4 id="location" className="text-xs bg-white border-2 border-black  p-2 rounded-lg font-semibold text-black">Tailwind CSS</h4>
                ...
                {/*Weather*/}
                <div className="flex mt-8  lg:p-0 p-4 hover:scale-105 transition  space-y-4 flex-col text-left">
                ...
                {/*Indeed*/}
                <div className="flex mt-8 border-b-2 hover:scale-105 transition  lg:p-0 p-4 space-y-4 flex-col text-left">
                ...
                {/*Onward Upward*/}
                <div className="flex lg:p-0 p-4 mt-8 hover:scale-105 transition  space-y-4 flex-col text-left">
