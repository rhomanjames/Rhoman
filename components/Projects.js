    ...
    return (
        <div className="w-full flex-col med:flex-row items-center align-center">
            ...
            <div className="w-full p-4 ">
                ...
                {/*Google*/}
                <div className="flex mt-8 lg:p-0 transition  p-4 border-b-2 space-y-4 flex-col text-left">
                ...
                {/*Weather*/}
                <div className="flex mt-8  lg:p-0 p-4 transition  space-y-4 flex-col text-left">
                ...
                {/*Indeed*/}
                <div className="flex mt-8 border-b-2 transition  lg:p-0 p-4 space-y-4 flex-col text-left">
                ...
                {/*Scriptures*/}
                <div className="flex mt-8  lg:p-0 p-4 transition border-b-2 border-gray-50  space-y-4 flex-col text-left">
