...
function Body() {
    return (
        ...
        <div className="">
            <div id="aboutMe" className="w-5/6 md:fixed ml-auto mr-auto md:w-1/6 left-4 transition mb-8 shadow-lg mr-auto md:mt-0 md:ml-8 md:p-2 bg-white  rounded-lg">
                < AboutMe />
            </div>
            <div id="Skills" className="w-5/6 md:fixed ml-auto mr-auto md:w-1/6 md:right-4 transition mb-8 shadow-lg md:mt-0 md:mr-8 md:p-2 bg-white  rounded-lg">
                < Skills />
            </div>
