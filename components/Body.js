...
function Body() {
    return (
        ...
        <div className="">
            ...
            <div id="test" className="w-5/6 md:w-1/2 lg:absolute lg:fixed ml-auto mr-auto lg:w-1/6 left-4 transition mb-8 shadow-lg mr-auto lg:mt-0 lg:ml-8 lg:p-2 bg-white border border-white rounded-lg">
                < AboutMe />
            </div>
