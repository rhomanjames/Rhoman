...
function Resume() {
    ...
    return (
        <div  id="home" className="w-full flex-col  med:flex-row items-center align-center">
             {/*Image and title*/}
            <div className="w-full lg:pl-4 px-8 py-2 flex pr-4 flex-grow  align-center items-center">
                ...
                <button id="hideBtn" onClick={resume}>Hide</button>
                </div>
    ...
    function resume (){
        let resume = document.getElementById('resumeContent');
