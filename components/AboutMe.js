        ...
        <div className="w-full flex-col med:flex-row items-center align-center">
            ...
            <div className="w-full p-4 ">
                ...
                <div className="flex mb-4 lg:p-0 p-4 space-y-4 flex-col text-left">
                    <h1 className="text-xl font-bold">My name is Rhoman James and I'm a web developer and community liaison at Fayette County Public Schools in KY. <br /> <br id="resume" /> I love front-end web development and I really enjoy creating modern, engaging websites with a pleasant user experience.</h1>
                </div>
            </div>
        </div>
